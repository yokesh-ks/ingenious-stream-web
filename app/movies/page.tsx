          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="relative h-[200px] rounded-2xl overflow-hidden bg-gradient-to-r from-purple-900 via-purple-700 to-pink-600 p-8">
              <div className="relative z-10">
                ...
                <p className="text-white/80 mt-2 text-sm">Watch your favorite movies anytime, anywhere</p>
              </div>
                ...
                {popularMovies.map((movie) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant="secondary" className="text-xs px-1.5 py-0">{movie.year}</Badge>
